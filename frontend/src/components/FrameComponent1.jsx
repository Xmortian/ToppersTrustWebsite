...
const FrameComponent1 = ({ className = "" }) => {
  return (
    <div
      className={`w-[42.813rem] flex flex-col items-start justify-start py-[0rem] pl-[0rem] pr-[1.25rem] box-border gap-[1.093rem] max-w-full text-left text-[0.938rem] text-[#fff] font-roboto ${className}`}
    >
      <div className="flex flex-row items-start justify-start py-[0rem] px-[0.937rem]">
        <div className="w-[10.688rem] bg-[#1368a4] overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[0.187rem] pb-[0.25rem] pl-[0.375rem] pr-[0rem] box-border">
